...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='train svm for JHMDB split1,2,3')
    ...
    if args.dists_list == '':
        ...
        clf_save_dir = 'svm_dists_split%d_' + args.model
        
    # gets dists_list_dir and clf_save_dir from given dists-list file
    else:
        dists_list_dir = args.dists_list
        clf_save_dir = 'svm_dists_split%d_' + args.dists_list[30:-4]
